...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-indigo-700 mb-4">Admin Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white rounded shadow p-4">
          <h2 className="font-semibold mb-2 text-indigo-700">Số lượng bài học theo chủ đề</h2>
        ...
        <div className="bg-white rounded shadow p-4">
          <h2 className="font-semibold mb-2 text-indigo-700">Tỷ lệ các level của chủ đề</h2>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={levelData}
